    ...
    <main className={styles.shell}>
      <header className={styles.header}>
        ...
        <div className={styles.headerRight}>
          <span className={styles.version}>{isPagesPreview ? "PRÉVIA PÚBLICA" : "VERSÃO 0.4.1"}</span>
          <ThemePicker />
        </div>
      </header>
      ...
      <footer className={styles.footer}><span>✳ ModuVita · Construído por etapas.</span><span>Versão 0.4.1 · 2026</span></footer>
    </main>
  );
}
